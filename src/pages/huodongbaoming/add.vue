...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    <el-form
      ...
      label-width="150px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="报名编号" prop="baomingbianhao">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="活动地址" prop="huodongdizhi">
            <el-input v-model="ruleForm.huodongdizhi" 
                placeholder="活动地址" clearable :disabled="true  ||ro.huodongdizhi"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="联系方式" prop="xueshengdianhua">
            <el-input v-model="ruleForm.xueshengdianhua" 
                placeholder="联系方式" clearable :disabled=" false  ||ro.xueshengdianhua"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="文件材料" prop="wenjiancailiao">
            <file-upload
            tip="点击上传文件材料"
            action="file/upload"
            :limit="1"
			:type="3"
            :multiple="true"
            :fileUrls="ruleForm.wenjiancailiao?ruleForm.wenjiancailiao:''"
            @change="wenjiancailiaoUploadChange"
            ></file-upload>
          </el-form-item>  
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="报名备注" prop="baomingbeizhu">
...
<script>
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='wenjiancailiao'){
              this.ruleForm.wenjiancailiao = obj[o];
              this.ro.wenjiancailiao = true;
              continue;
            }
            if(o=='baomingbeizhu'){
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.xueshengdianhua!=''&&json.xueshengdianhua) || json.xueshengdianhua==0){
                this.ruleForm.xueshengdianhua = json.xueshengdianhua;
				this.ro.xueshengdianhua = true;
            }
          }
        });
    ...
    // 多级联动参数
      ...
      wenjiancailiaoUploadChange(fileUrls) {
          this.ruleForm.wenjiancailiao = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");
      },
    }
  };
</script>
