...
<div class="home-preview" :style='{"margin":"0px auto","flexWrap":"wrap","flexDirection":"row","background":"#fff","display":"flex","width":"100%","justifyContent":"center"}'>
		...
		<div id="system" class="animate__animated" :style='{"padding":"0 12% 80px","margin":"0 auto","flexWrap":"wrap","background":"#f1f1f1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"4"}'>
		  ...
		  <div :style='{"width":"100%","margin":"40px 0 0","background":"url(http://codegen.caihongy.cn/20231010/fa45131753e2441b8eb1996ef7443eb8.png) no-repeat center top / 100% 100%","display":"none","height":"139px","order":"9"}' />
		  <div :style='{"width":"285px","background":"url(http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
		  <div :style='{"width":"285px","background":"url(http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
		  <div :style='{"width":"285px","background":"url(http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
		  <div :style='{"border":"0px solid #1d8001","cursor":"pointer","padding":"0 10px 0 0","margin":"0","textAlign":"right","bottom":"250px","display":"block","justifyContent":"center","left":"calc(51% + 0px)","background":"url(http://codegen.caihongy.cn/20231010/b72adcd3865b46389aba91ec7423d34c.png) no-repeat center top / 100% 100%","width":"240px","lineHeight":"59px","position":"absolute","order":"8","height":"59px"}' @click="toDetail('systemintroDetail',systemIntroductionDetail)">
...
<!-- 商品推荐 -->
<div id="animate_recommendhuodongxinxi" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"76%","padding":"45px 0 0","margin":"0px auto","textAlign":"left","background":"url() no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"32px","color":"#000","fontWeight":"600","display":"block"}'>活动信息推荐</span>
	</div>
		...
		<div v-if="huodongxinxiRecommend.length" class="list list16 index-pv1" :style='{"padding":"0 12%","margin":"20px 0 0","color":"#999","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","height":"auto"}'>
		  <div v-for="item,index in huodongxinxiRecommend" :key="index"  @click="toDetail('huodongxinxiDetail', item)" class="list-item animation-box">
		    <div :style='{"border":"0px solid red","width":"100%","padding":"0px","overflow":"hidden","height":"320px"}' class="img-box">
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-if="preHttp(item.huodongzhaopian)" :src="item.huodongzhaopian.split(',')[0]" alt="" />
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-else :src="baseUrl + (item.huodongzhaopian?item.huodongzhaopian.split(',')[0]:'')" alt="" />
			</div>
		    <div :style='{"width":"100%","padding":"0","overflow":"hidden","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0 10px","flexWrap":"wrap","display":"flex"}'>
				...
				<div class="title">{{item.huodongfenlei}}</div>
		        ...
		        <div :style='{"padding":"0 10px","borderColor":"red","borderStyle":"solid","borderWidth":"0","display":"inline-block"}' class="publisher">
		          ...
		          <span class="text">{{item.zuzhizhanghao}}</span>
		        </div>
...
<!-- 特价商品 -->
<div id="animate_listzuzhixinxi" class="lists animate__animated" :style='{"width":"100%","padding":"20px 0 60px","margin":"0px auto 20px","position":"relative","background":"#fff","order":"3"}'>
	...
	<div class="title" :style='{"width":"76%","padding":"40px 0 0","margin":"0px auto","textAlign":"left","background":"url() no-repeat left top / auto 52px","height":"90px"}'>
	  <span :style='{"padding":"0","fontSize":"32px","color":"#000","fontWeight":"600","display":"block","font":"\"宋体\""}'>组织信息展示</span>
	</div>
		...
		<div v-if="zuzhixinxiList.length" :style='{"padding":"0 12%","color":"#fff","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","height":"auto"}' class="list list17 index-pv1">
		  <div v-for="item,index in zuzhixinxiList" :key="index"  @click="toDetail('zuzhixinxiDetail', item)" :style='{"cursor":"pointer","margin":"40px 0 0","overflow":"hidden","background":"#fff","width":"31%","position":"relative","height":"480px"}' class="item">
				<img class="image" v-if="preHttp(item.zuzhizhaopian)" :src="item.zuzhizhaopian.split(',')[0]" alt="" />
				<img class="image" v-else :src="baseUrl + (item.zuzhizhaopian?item.zuzhizhaopian.split(',')[0]:'')" alt="" />
			<div class="content">
		      <div :style='{"color":"#fff","alignItems":"center","display":"none","width":"100%","lineHeight":"24px","fontSize":"14px","textIndent":"2em"}'>{{item.zuzhimiaoshu}}</div>
		      <div class="info">
				<div :style='{"margin":"0 0 10px","color":"#fff","textAlign":"left","background":"rgba(0,0,0,0)","width":"100%","lineHeight":"40px","fontSize":"16px"}' class="name ">{{item.zuzhimingcheng}}</div>
		        ...
		        <div :style='{"padding":"0","margin":"0 10px 0 0","display":"inline-block"}'>
		          <span class="icon iconfont icon-geren16" :style='{"margin":"0 2px 0 0","lineHeight":"1.5","fontSize":"inherit","color":"#9dc0f9"}'></span>
		          <span :style='{"color":"inherit","lineHeight":"1.5","fontSize":"inherit"}'>{{item.zuzhizhanghao}}</span>
		        </div>
		        <div :style='{"padding":"0","margin":"0 10px 0 0","display":"inline-block"}'>
		          <span class="icon iconfont icon-shoucang10" :style='{"margin":"0 2px 0 0","lineHeight":"1.5","fontSize":"inherit","color":"#a2f99d"}'></span>
	...
	<div @click="moreBtn('zuzhixinxi')" :style='{"border":"0px solid #1d8001","cursor":"pointer","padding":"0 20px 0 0","margin":"40px -12px 0 0","textAlign":"right","display":"block","right":"12%","top":"0","background":"url(http://codegen.caihongy.cn/20231010/b345185c76ac4a77bf4cd6f6171a72ed.png) no-repeat center top / 100% 100%","width":"240px","lineHeight":"73px","position":"absolute","height":"80px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
		<i :style='{"color":"#333","fontSize":"16px","display":"none"}' class="icon iconfont icon-jiantou09"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_listzuzhixinxi',css:'animate__'},
      ...
      getSystemIntroduction() {
		...
		getList() {
          ...
          autoSortUrl = "huodongxinxi/autoSort";
			...
			this.$http.get('zuzhixinxi/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.zuzhixinxiList = res.data.data.list;
